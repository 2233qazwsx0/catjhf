...
msg:remove()
wait(1)
                local OrionLib = loadstring(game:HttpGet("https://pastebin.com/raw/yDVWkjx6"))()--ui


local Window = OrionLib:MakeWindow({Name = "StarsCat", HidePremium = false, SaveConfig = false, IntroText = ""..identifyexecutor(), ConfigFolder = "StarsCat"})
...
Tab:AddParagraph("","CUA")
Tab:AddLabel("QQ3290274245")
Tab:AddLabel("QQ282782261")
...
Tab:AddButton({
    Name = "CUA",
    Callback = function()
    loadstring("\112\114\105\110\116\40\34\104\116\116\112\115\58\47\47\112\97\115\116\101\98\105\110\46\99\111\109\47\114\97\119\47\72\75\68\81\121\75\107\85\34\41\10")()
    end
})
...
Tab:AddButton({
    Name = "",
    Callback = function()
    getgenv().he=""loadstring(game:HelpGet("https://pastebin.com/raw/2WmdapD2"))()
    end
})
...
Tab:AddButton({
    Name = "v3",
    Callback = function()
   jianke_V3 = "_"jianke = "QQ347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/jiankeQWQ/jiankeV3/main/jianke_V3')))()
    end
})
...
Tab:AddButton({
    Name = "",
    Callback = function()
    getgenv().ren666 = ""loadstring(game:HttpGet(utf8.char((function() return table.unpack({104,116,116,112,115,58,47,47,112,97,115,116,101,98,105,110,46,99,111,109,47,114,97,119,47,90,77,115,67,56,114,104,114})end)())))();
    end
})
...
Tab:AddButton({
	Name = "",
	Callback = function()
mouse = game.Players.LocalPlayer:GetMouse() tool = Instance.new("Tool") tool.RequiresHandle = false tool.Name = "" tool.Activated:connect(function() local pos = mouse.Hit+Vector3.new(0,2.5,0) pos = CFrame.new(pos.X,pos.Y,pos.Z) game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = pos end) tool.Parent = game.Players.LocalPlayer.Backpack
	end
})
